    ...
    <div className="min-h-[100dvh] bg-white flex flex-col px-6">
      <div className="pt-14 pb-8 flex-1">
        <button 
          ...
          className="w-10 h-10 flex items-center justify-center rounded-full bg-muted hover:bg-muted/80 transition-colors mb-8 -ml-2"
        >
          <ArrowLeft className="w-5 h-5" />
        </button>
        
        <h1 className="text-3xl font-bold mb-2">验证码</h1>
        <p className="text-muted-foreground mb-10 text-sm leading-relaxed">
          我们已将 4 位验证码发送至 <br/>
          <span className="font-semibold text-foreground">+213 05 50 12 34 56</span>
        </p>
