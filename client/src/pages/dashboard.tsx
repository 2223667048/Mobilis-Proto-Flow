    ...
    <div className="min-h-[100dvh] bg-background pb-28">
      ...
      <div className="px-4 -mt-16 relative z-20">
        <div className="glass bg-white rounded-3xl p-4 shadow-xl flex justify-between gap-2">
          ...
          <button className="flex-1 flex flex-col items-center justify-center py-2 gap-2 group">
      ...
      <div className="px-4 mt-8 space-y-6">
        ...
        <section>
          ...
          <div className="bg-white rounded-3xl p-5 shadow-sm border border-border">
            ...
            <div className="flex items-end justify-between mt-4 mb-3">
              <div>
                <span className="text-3xl font-bold font-heading">12.5</span>
        ...
        <section>
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-sm h-40">
            <img src={banner1} alt="Promo" className="w-full h-full object-cover" />
            <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-transparent p-5 flex flex-col justify-center">
              ...
              <button className="mt-auto text-sm font-semibold text-white flex items-center w-fit hover:underline">
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-4 gap-4">
            {[
              { icon: Plus, label: "服务变更", color: "bg-purple-100 text-purple-600" },
              { icon: ShieldAlert, label: "PUK码", color: "bg-red-100 text-red-600" },
              { icon: Star, label: "积分商城", color: "bg-yellow-100 text-yellow-600" },
              { icon: CreditCard, label: "账单查询", color: "bg-blue-100 text-blue-600" },
            ].map((item, i) => (
              <div key={i} className="flex flex-col items-center gap-2">
                <button className={`w-14 h-14 rounded-2xl ${item.color} flex items-center justify-center hover:scale-105 transition-transform`}>
